 ...
 *
*/
#ifndef _GAZEBO_YARP_SERVER_FIXTURE_HH_
#define _GAZEBO_YARP_SERVER_FIXTURE_HH_
...
class GazeboYarpServerFixture : public testing::Test
{
  /// \brief Constructor
  public: GazeboYarpServerFixture();

  /// \brief Destructor
  public: virtual ~GazeboYarpServerFixture();
...
#endif  // define _GAZEBO_YARP_SERVER_FIXTURE_HH_
