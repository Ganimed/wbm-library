...
/////////////////////////////////////////////////
GazeboYarpServerFixture::GazeboYarpServerFixture()
{
  this->server = NULL;
  ...
  gazebo::common::SystemPaths::Instance()->AddGazeboPaths(WORLD_PATH);
  gazebo::common::SystemPaths::Instance()->AddModelPaths(MODEL_PATH);
...
GazeboYarpServerFixture::~GazeboYarpServerFixture()
{
    std::cout << "Called GazeboYarpServerFixture destructor. " << std::endl;
}

/////////////////////////////////////////////////
void GazeboYarpServerFixture::TearDown()
{
  this->Unload();
}

/////////////////////////////////////////////////
void GazeboYarpServerFixture::Unload()
{
  //Unloading Gazebo
  gzdbg << "GazeboYarpServerFixture::Unload" << std::endl;
  gzdbg << "GazeboYarpServerFixture::Unload Gazebo" << std::endl;
  this->serverRunning = false;
  if (this->node)
    this->node->Fini();
  ...
  this->serverThread = NULL;
  gzdbg << "GazeboYarpServerFixture::Unload yarpserver" << std::endl;
  yarp::os::Network::fini();
  system("pkill yarpserver");
}

/////////////////////////////////////////////////
void GazeboYarpServerFixture::Load(const std::string &_worldFilename)
{
  this->Load(_worldFilename, false);
}

/////////////////////////////////////////////////
void GazeboYarpServerFixture::Load(const std::string &_worldFilename, bool _paused)
{
                  ...
                  bool _paused, const std::string &_physics)
{
  ...
  // Wait for the yarp server to go up
  yarp::os::Time::delay(0.50);
  ...
  ASSERT_TRUE(yarp::os::Network::checkNetwork(0.5));
  ...
  this->serverThread = new boost::thread(
     boost::bind(&GazeboYarpServerFixture::RunServer, this, _worldFilename,
                 _paused, _physics));
  ...
  gzdbg << "GazeboYarpServerFixture load in "
  ...
  this->poseSub = this->node->Subscribe("~/pose/local/info",
      &GazeboYarpServerFixture::OnPose, this, true);
  this->statsSub = this->node->Subscribe("~/world_stats",
      &GazeboYarpServerFixture::OnStats, this);
...
/////////////////////////////////////////////////
void GazeboYarpServerFixture::RunServer(const std::string &_worldFilename)
{
  this->RunServer(_worldFilename, false, "");
}

/////////////////////////////////////////////////
rendering::ScenePtr GazeboYarpServerFixture::GetScene(
...
/////////////////////////////////////////////////
void GazeboYarpServerFixture::RunServer(const std::string &_worldFilename, bool _paused,
...
/////////////////////////////////////////////////
void GazeboYarpServerFixture::OnStats(ConstWorldStatisticsPtr &_msg)
{
...
/////////////////////////////////////////////////
void GazeboYarpServerFixture::SetPause(bool _pause)
{
  physics::pause_worlds(_pause);
}

/////////////////////////////////////////////////
double GazeboYarpServerFixture::GetPercentRealTime() const
{
...
/////////////////////////////////////////////////
void GazeboYarpServerFixture::OnPose(ConstPosesStampedPtr &_msg)
{
...
/////////////////////////////////////////////////
math::Pose GazeboYarpServerFixture::GetEntityPose(const std::string &_name)
{
  boost::mutex::scoped_lock lock(this->receiveMutex);
...
/////////////////////////////////////////////////
bool GazeboYarpServerFixture::HasEntity(const std::string &_name)
{
  boost::mutex::scoped_lock lock(this->receiveMutex);
  std::map<std::string, math::Pose>::iterator iter;
  iter = this->poses.find(_name);
...
/////////////////////////////////////////////////
void GazeboYarpServerFixture::PrintImage(const std::string &_name, unsigned char **_image,
...
/////////////////////////////////////////////////
void GazeboYarpServerFixture::PrintScan(const std::string &_name, double *_scan,
...
/////////////////////////////////////////////////
void GazeboYarpServerFixture::FloatCompare(float *_scanA, float *_scanB,
...
/////////////////////////////////////////////////
void GazeboYarpServerFixture::DoubleCompare(double *_scanA, double *_scanB,
...
/////////////////////////////////////////////////
void GazeboYarpServerFixture::ImageCompare(unsigned char *_imageA,
...
/////////////////////////////////////////////////
void GazeboYarpServerFixture::OnNewFrame(const unsigned char *_image,
...
/////////////////////////////////////////////////
void GazeboYarpServerFixture::GetFrame(const std::string &_cameraName,
    ...
    unsigned int &_height)
{
  ...
  event::ConnectionPtr c =
    camSensor->GetCamera()->ConnectNewImageFrame(
        boost::bind(&GazeboYarpServerFixture::OnNewFrame,
                    this, _1, _2, _3, _4, _5));
...
/////////////////////////////////////////////////
void GazeboYarpServerFixture::SpawnCamera(const std::string &_modelName,
...
/////////////////////////////////////////////////
void GazeboYarpServerFixture::SpawnRaySensor(const std::string &_modelName,
...
/////////////////////////////////////////////////
void GazeboYarpServerFixture::SpawnGpuRaySensor(const std::string &_modelName,
    const std::string &_raySensorName,
    const math::Vector3 &_pos, const math::Vector3 &_rpy,
    double _hMinAngle, double _hMaxAngle,
    double _minRange, double _maxRange,
...
/////////////////////////////////////////////////
void GazeboYarpServerFixture::SpawnImuSensor(const std::string &_modelName,
...
/////////////////////////////////////////////////
void GazeboYarpServerFixture::SpawnUnitContactSensor(const std::string &_name,
...
/////////////////////////////////////////////////
void GazeboYarpServerFixture::SpawnUnitImuSensor(const std::string &_name,
    const std::string &_sensorName,
...
/////////////////////////////////////////////////
void GazeboYarpServerFixture::launchTimeoutFailure(const char *_logMsg,
                                         const int _timeoutCS)
{
     FAIL() << "GazeboYarpServerFixture timeout (wait more than " << _timeoutCS / 100
            << "s): " << _logMsg;
}

/////////////////////////////////////////////////
void GazeboYarpServerFixture::SpawnWirelessTransmitterSensor(const std::string &_name,
    const std::string &_sensorName,
...
/////////////////////////////////////////////////
void GazeboYarpServerFixture::SpawnWirelessReceiverSensor(const std::string &_name,
    const std::string &_sensorName,
    const math::Vector3 &_pos,
    const math::Vector3 &_rpy,
    double _minFreq,
...
/////////////////////////////////////////////////
void GazeboYarpServerFixture::WaitUntilEntitySpawn(const std::string &_name,
                        ...
                        int _retries)
{
  ...
  if (i >= _retries)
    FAIL() << "GazeboYarpServerFixture timeout: max number of retries ("
           << _retries
           << ") exceeded while awaiting the spawn of " << _name;
}

/////////////////////////////////////////////////
void GazeboYarpServerFixture::WaitUntilSensorSpawn(const std::string &_name,
                        unsigned int _sleepEach,
                        int _retries)
{
  int i = 0;
...
/////////////////////////////////////////////////
void GazeboYarpServerFixture::SpawnLight(const std::string &_name,
...
/////////////////////////////////////////////////
void GazeboYarpServerFixture::SpawnCylinder(const std::string &_name,
    const math::Vector3 &_pos, const math::Vector3 &_rpy,
    bool _static)
{
  msgs::Factory msg;
...
/////////////////////////////////////////////////
void GazeboYarpServerFixture::SpawnSphere(const std::string &_name,
    const math::Vector3 &_pos, const math::Vector3 &_rpy,
...
/////////////////////////////////////////////////
void GazeboYarpServerFixture::SpawnBox(const std::string &_name,
...
/////////////////////////////////////////////////
void GazeboYarpServerFixture::SpawnTrimesh(const std::string &_name,
...
/////////////////////////////////////////////////
void GazeboYarpServerFixture::SpawnEmptyLink(const std::string &_name,
    const math::Vector3 &_pos, const math::Vector3 &_rpy,
    bool _static)
{
  msgs::Factory msg;
...
/////////////////////////////////////////////////
void GazeboYarpServerFixture::SpawnModel(const std::string &_filename)
{
  msgs::Factory msg;
...
/////////////////////////////////////////////////
void GazeboYarpServerFixture::SpawnSDF(const std::string &_sdf)
{
  msgs::Factory msg;
  msg.set_sdf(_sdf);
  this->factoryPub->Publish(msg);
...
/////////////////////////////////////////////////
void GazeboYarpServerFixture::LoadPlugin(const std::string &_filename,
...
/////////////////////////////////////////////////
physics::ModelPtr GazeboYarpServerFixture::GetModel(const std::string &_name)
{
  // Get the first world...we assume it the only one running
  physics::WorldPtr world = physics::get_world();
...
/////////////////////////////////////////////////
void GazeboYarpServerFixture::RemoveModel(const std::string &_name)
{
...
/////////////////////////////////////////////////
void GazeboYarpServerFixture::RemovePlugin(const std::string &_name)
{
  // Get the first world...we assume it the only one running
  physics::WorldPtr world = physics::get_world();
